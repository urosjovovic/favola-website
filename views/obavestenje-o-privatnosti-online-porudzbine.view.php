...
<p>Obrada je svaka radnja ili skup radnji koje se vrše sa podacima o ličnosti ili njihovim skupovima (npr. prikupljanje, skladištenje, upotreba, umnožavanje, objavljivanje, brisanje ili uništavanje).</p>

<p>Restoran je rukovalac Vašim ličnim podacima. Ovo će biti detaljnije pojašnjeno u nastavku.</p>
...
<p>Koristimo samo one lične podatke koji su neophodni za tačno određenu svrhu i uvek se trudimo da ograničimo obradu ličnih podataka u odnosu na ono što je neophodno za tu svrhu. </p>

<p>Primarna svrha obrade Vaših ličnih podataka je korišćenje usluge online naručivanja preko Vebsajta.</p>
...
<p>Takođe, možemo da delimo Vaše lične podatke sa sledećim primaocima:</p>

<ol>
<li>Podizvođačima, spoljnim konsultantima, advokatima, knjigovođama, komercijalnim bankama, i ostalim trećim licima, kao što su:
    <li>Cloud servisi, hosting servisi, infrastruktura i support;</li>
    <li>Pružaoci usluga oglašavanja i marketinških usluga;</li>
    <li>Bilo kojem drugom primaocu, ukoliko smo u obavezi prema zakonu ili na osnovu sudske odluke;</li>
    <li>Bilo kojem drugom primaocu kada je to razumno i neophodno, npr. u slučaju opasnosti po život.</li>
</li>
</ol>
...
<p>Imate sledeća prava: </p>
<ol>

<li>Informisanje: pravo da budete informisani o tome na koji način obrađujemo Vaše lične podatke (ovo pravo je ispunjeno davanjem na uvid ovog Obaveštenja);</li>
<li>Pristup: pravo da zahtevate od nas pristup svim Vašim ličnim podacima koje obrađujemo. Ukoliko zahtev dostavite elektronskim putem, informacije se dostavljaju u uobičajeno korišćenom elektronskom obliku, osim ako zahtevate drugačije dostavljanje;</li>
<li>Ispravka/dopuna: pravo da tražite da se netačni ili nepotpuni lični podaci o Vama isprave bez odlaganja. Molimo Vas da nas obavestite ukoliko promenite te lične podatke ili ukoliko saznate da su bilo koji lični podaci koje držimo netačni ili nepotpuni;</li>
<li>Brisanje: pravo da zahtevate da se obrišu Vaši lični podaci bez odlaganja (uz poštovanje ograničenja koja su postavljena zakonom);</li>
<li>Ograničenje: pravo da tražite ograničenje obrade Vaših ličnih podataka u određenim situacijama;</li>
<li>Prigovor: pravo da izjavite prigovor na specifične obrade ličnih podataka. Ovo uključuje direktno oglašavanje, obradu u svrhe naučnog ili istorijskog istraživanja ili u statističke svrhe;</li>
<li>Prenosivost: pravo da zahtevate od nas da ove podatke prenesemo drugoj kompaniji, ako je obrada zasnovana na pristanku ili na osnovu ugovora i obrada se vrši automatizovanim putem. U slučaju da želite, mi čemo vam (i) dostaviti podatke u strukturiranom, uobičajenom i mašinski čitljivom formatu i (ii) omogućiti prenos podataka drugom rukovaocu.</li>
</ol>

<p>Vaša prava možete da ostvarite bez ikakvih dodatnih troškova slanjem zahteva na sledeću imejl adresu: keteringdenis@gmail.com. Na Vaš zahtev odgovorićemo u najkraćem mogućem roku, a najkasnije u roku od 30 dana od dana prijema zahteva. U slučaju složenosti ili velikog broja zahteva, moguće je da će nam biti potreban dodatan rok za odgovor na zahtev. Taj rok ne može biti duži od 90 dana i o tome ćemo Vas posebno obavestiti. Ako je iz nekog razloga pristup ostvarivanju Vaših prava odbijen, pruži ćemo Vam objašnjenje zašto je do toga došlo.</p>

<p>Ukoliko smatrate da Vam je neko od prethodno navedenih prava uskraćeno ili smatrate da na neki način obrađujemo Vaše lične podatke protivno zakonu, molimo Vas da nam se obratite na sledeću imejl adresu: keteringdenis@gmail.com. U svakom trenutku možete da podnesete pritužbu Povereniku za informacije od javnog značaja i zaštitu podataka o ličnosti.</p>

<h2>14.	Pristanak i povlačenje pristanka</h2>

<p>U svakom trenutku možete povući pristanak za obradu Vaših ličnih podataka koju ste nam dali. Mi ćemo odmah reagovati i zaustaviti obradu tih ličnih podataka. Ovo pravo je besplatno. Zahtev za povlačenje pristanka  možete nam poslati na sledeću imejl adresu: keteringdenis@gmail.com.   </p>
...
<p>Restaurant collects and uses your first and last name, email address, delivery address, phone number, as well as other data that you enter on the Website when placing an online order, exclusively for the purpose of successfully completing your order and fulfilling legal and other obligations of the controller and/or processor of your personal data.</p>
<h2>6.	Purpose of Processing and Legal Basis for Processing</h2>
<p>We process your personal data if this processing is necessary to conclude and execute a contract with you. We can process your personal data if we are legally obliged to do so. Also, we can process your personal data if the processing is necessary to protect your vital interests. If we process your personal data based on our legal obligations or to protect your vital interests, you will be opportunely informed. We may also process your personal data to achieve our legitimate business interests.</p>
<p>We exclusively use personal data which is necessary for a pre-defined specific purpose, and we always try to limit the processing of personal data to what is necessary to achieve that purpose.</p>
The primary purpose of processing your personal data is so you can use the online ordering service on the Website.</p>
<p>By accepting the Terms of Use, you are concluding a contract with us. We process your personal data for the purpose of concluding and executing that contract.</p>
<h2>7.	Processors </h2>
<p>Restaurant hired Pin Technology d.o.o. Belgrade-Savski Venac in order to provide the service of online ordering of food and other products, and on that occasion, Pin Technology d.o.o. Belgrade-Savski Venac processes your personal data.</p>
<p>Restaurant has signed personal data processing contracts with all the processors.</p>
<h2>8.	Recipients of Personal Data</h2>
<p>Until the successful completion of your online order, your personal data is available exclusively to Restaurant and Pin Technology d.o.o. Belgrade-Savski Venac.</p>
<p>We may also share your personal information with the following recipients:</p>
<ol>
<li>To subcontractors, external consultants, lawyers, accountants, banks, and other third parties, such as:
<li>Cloud services, hosting services, infrastructure and support;</li>
<li>Providers of advertising and marketing services;</li>
<li>To any other recipient, if we are legally obliged or based on a court decision;</li>
<li>To any other recipient when it is reasonable and necessary, e.g. in life threatening cases.</li>
</li>
</ol>
<p>All data recipients shall take appropriate technical, organizational and personnel measures to protect your personal data and your rights. Restaurant has signed personal data processing contracts with all the recipients.</p>
<h2>9.	Transfer of Personal Data to Other Countries</h2>
<p>Personal data may be transferred to third countries without any safeguards when transferred to countries located in the EU, countries signatory to Convention 108 (Serbia) and countries determined by the European Union to provide an adequate level of protection.</p>
<p>If personal data is transferred to a country that is not in the EU or to a country that is not a signatory to Convention 108 (Serbia) or to a country that has not been determined by the European Union to provide an adequate level of protection, we apply appropriate safeguard measures (e.g. signed standard contractual clauses).</p>
<h2>10.	Storage Period</h2>
<p>Restaurant does not store your personal data.</p>
<p>Your data is available to authorized persons only, until the successful completion of the online order at the latest, except for data that is necessary for the delivery of an electronic fiscal invoice to your email address and the fulfilment of any other legal obligations of the Restaurant, in which case the said data may be available to authorized persons for an extended period. For more information about where and how long your personal data is stored, as well as for more information about your rights to deletion of data and data portability, please contact us at the following email address: keteringdenis@gmail.com.</p>
<h2>11.	Personal Data Safety</h2>
<p>We implement appropriate physical, procedural, technical, organizational and personnel measures to achieve an appropriate level of protection of your personal data. We apply the best industry standards in data protection. Protection covers the loss, misuse, unauthorized access and inspection, modification, and destruction of personal data. No security measure can guarantee that personal data will be 100% protected, therefore, at every given moment, by using our controlled processes and with extended responsibility, we are constantly improving all security measures in order to protect your personal data.</p>
<h2>12.	We Do Not Collect Personal Data from Minors Under the Age of 15</h2>
...
<p>You may exercise certain rights in relation to the personal data we process. You can submit a request to exercise these rights at any time.</p>
<ol>
<li>You have the following rights:
<li>Informing: the right to be informed about how we process your personal data (this right is fulfilled by making this Notice available);</li>
<li>Access: the right to request from us access to all your personal data that we process. If you submit the request electronically, the information is submitted in a commonly used electronic form, unless you request a different type of submission;</li>
<li>Correction/addition: the right to request that your inaccurate or incomplete personal data be corrected without delay. Please notify us if you change any of the personal data or if you become aware that any personal data we hold is incorrect or incomplete;</li>
<li>Deletion: the right to request the deletion of your personal data without delay (subject to the limitations set by law);</li>
<li>Limitation: the right to limit the processing of your personal data in certain situations;</li>
<li>Objection: the right to object to specific processing of personal data. This includes direct advertising, processing for scientific or historical research purposes or for statistical purposes;</li>
<li>Portability: the right to request the transfer of personal data to another company if the processing is based on consent or on a contract and the processing is carried out by automated means. In case you require so, we (i) deliver the data to you in a structured, common and machine-readable format and (ii) enable the transfer of the data to another controller.</li>
</li>
</ol>
<p>You can exercise your rights at no additional cost by sending a request to the following email address: keteringdenis@gmail.com. We respond to your requests as soon as possible, and no later than within 30 days from the date of receiving the request. Depending on the complexity of the matter or a large number of requests, it is possible that we extend the response period. That period however cannot be prolonged for more than 90 days, and we will inform you about it separately. If for some reason access to exercising your rights is denied, we will provide you with an explanation as to why this happened.</p>
<p>If you believe that any of the aforementioned rights have been denied to you or you believe that we are in any way illegally processing your personal data, please contact us at the following email address: keteringdenis@gmail.com. You can file a complaint with the Commissioner for Information of Public Importance and Personal Data Protection at any time.</p>
<h2>14.	Consent and Withdrawal of Consent</h2>
<p>You can withdraw your consent to the processing of your personal data at any time. This calls for our immediate reaction and an instant termination of processing of your personal data. Exercising this right is free of charge. You can send us a request to withdraw your consent to the following email address: keteringdenis@gmail.com.</p>
</div>
<!-- Page content end -->
<?php
