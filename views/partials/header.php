  ...
  <div class="container p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-3 mb-2 mb-lg-0 ms-3">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/#sendvici">Sendviči</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/#palacinke-slane">Palačinke Slane</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/#palacinke-slatke">Palacinke slatke</a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-md-none">
        <a class="ms-auto" href="tel:+381628950833">Telefon: +38162 895 0833</a>
        <span class="radno-vreme">Radno vreme - Pon-Sub: 12:00-03:30h</span>
        <span class="radno-vreme">Adresa: Ljubićka 11, Beograd</span>
      </div>
    </div>
  </div>
</nav>
