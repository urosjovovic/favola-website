...
function productCardPrintCol6ColMd3($itemid, $item_images_path_array, $item_name, $item_size, $item_price, $item_description) {
    try {
        if (array_key_exists($itemid, $item_images_path_array)) {
            ...
            <div class="card">
            <img class="card-img-top" '.imageSrcSetMenuItem($itemid, $item_images_path_array).' alt="'.$item_name.'">
            <div class="card-body">
                <h3 class="card-title h4">'.$item_name.'</h3>
                <p class="card-text">'.$item_size.'</p>
